Welcome to the aRt with R welcome pack. 
...
Within your welcome pack you should find the following:
	...
	- R setup instructions provided by the R users Yammer Group, R_Setup_Instructions_2019.docx
	...
	- This sessions accompanying worksheet, both for initial R-users (R_worksheet_beg.R) and 
		advanced R-users (R_worksheet_adv.R), including long and short forms
	- Some Inspiration / Hints code: insp.R
...
Please ensure the machine you will be working from during the session has an Rstudio bundle installed correctly, once completed, please complete the following steps to familiarise yourself with the RStudio interface.
	...
	1) Open Rstudio and Load the Core R-project File (aRt_with_R.Rproj)
	...
	2) Highlight and Run Lines 3 to 13, this will install and load the packages "Tidyverse" and others, which includes our main plotting 
...
Optional Extra: 
	...
	If you have chance, I would advice looking through both the insp.R and walkthrough_ppt.R to get familiar with the potential content of our session. This however is purely optional and to get you familiar with things which we are planning to cover! 
